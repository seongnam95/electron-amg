...
export function ContractArticle({
  ...
  if (printView) {
    return (
      <StyledContractArticlePrint>{ArticleContent}</StyledContractArticlePrint>
    );
  } else {
    return <StyledContractArticle>{ArticleContent}</StyledContractArticle>;
  }
}

const StyledContractArticle = styled.div`
  display: flex;
...
// styled
const StyledContractArticlePrint = styled.div`
  display: flex;
  flex-direction: column;
  gap: 2.6rem;
